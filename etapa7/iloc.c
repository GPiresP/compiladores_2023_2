...
void print_code(iloc_code *code, char *buffer)
{
    if(code != NULL)
    {
        if(code->num_ops == 0)
        ...
        */
        ...
        for(i = 0; i < num_ops; i++)
        {
            if (strcmp(code->ops[i]->opcode, "nop") == 0) {
                sprintf(temp_buffer, "nop");
                strcat(buffer, temp_buffer);
            } else if (strcmp(code->ops[i]->opcode, "add") == 0) {
                sprintf(temp_buffer, "add ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_1.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                }else if (code->ops[i]->arg_1.value == -3){
                    sprintf(temp_buffer, "rfp");
                    strcat(buffer, temp_buffer);
                }else {
                    sprintf(temp_buffer, "r%d", code->ops[i]->arg_1.value);
                    strcat(buffer, temp_buffer);
                }
                sprintf(temp_buffer, ", ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_2.value == -2){
                    ...
                    sprintf(temp_buffer, "r%d", code->ops[i]->arg_2.value);
                    strcat(buffer, temp_buffer);
                }
                sprintf(temp_buffer, " => ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_3.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                }else if (code->ops[i]->arg_3.value == -3){
                    sprintf(temp_buffer, "rfp");
                    strcat(buffer, temp_buffer);
                }else {
                    sprintf(temp_buffer, "r%d", code->ops[i]->arg_3.value);
                    strcat(buffer, temp_buffer);
                }
            } else if (strcmp(code->ops[i]->opcode, "sub") == 0) {
                sprintf(temp_buffer, "sub ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_1.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                ...
                sprintf(temp_buffer, ", %d => ", code->ops[i]->arg_2.value);
                strcat(buffer, temp_buffer); // não sei se o arg_2 tem que mexer tbm
                if (code->ops[i]->arg_3.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                }else if (code->ops[i]->arg_3.value == -3){
                ...
                sprintf(temp_buffer, "loadI %d", code->ops[i]->arg_1.value);
                strcat(buffer, temp_buffer);
                sprintf(temp_buffer, " => ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_2.value == -2){
                ...
                sprintf(temp_buffer, ", %d", code->ops[i]->arg_3.value);
                strcat(buffer, temp_buffer);
            } else if (strcmp(code->ops[i]->opcode, "storeAO") == 0) {
                sprintf(temp_buffer, "storeAO ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_1.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                ...
                sprintf(temp_buffer, " -> L%d, L%d", code->ops[i]->arg_2.value, code->ops[i]->arg_3.value);
                strcat(buffer, temp_buffer); // não se o L%d se mexe
            } else if (strcmp(code->ops[i]->opcode, "jumpI") == 0) {
                sprintf(temp_buffer, "jumpI -> L%d", code->ops[i]->arg_1.value);
                strcat(buffer, temp_buffer);
            } else if (strcmp(code->ops[i]->opcode, "jump") == 0) {
                sprintf(temp_buffer, "jump -> ");
                strcat(buffer, temp_buffer);
                if (code->ops[i]->arg_1.value == -2){
                    sprintf(temp_buffer, "rbss");
                    strcat(buffer, temp_buffer);
                ...
                sprintf(temp_buffer, "L%d:", code->ops[i]->arg_1.value);
                strcat(buffer, temp_buffer);
            }
